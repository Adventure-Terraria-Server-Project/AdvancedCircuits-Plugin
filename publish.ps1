...
$gitHubRepoName = "AdvancedCircuits-Plugin"

# information used to update the ressource on tshock.co
$tshockUser = "CoderCow@gmx.de"
$tshockResourceUri = "https://tshock.co/xf/index.php?resources/advanced-circuits.192/"
...
$binariesToPublish = @(
  ...
  "$outDir\SignCommands.dll",
  "$outDir\SignCommands.pdb"
)
